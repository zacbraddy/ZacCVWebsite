  ...
  <>
    ...
    <div className="grid gap-x-4 gap-y-8 lg:gap-y-16 lg:grid-cols-2">
      <AbilityDescription title="Software Engineering" icon={faTerminal}>
        <p>
          With experience across various technologies and project sizes,
          I&apos;ve honed my ability to pragmatically{' '}
          <Highlight>
      ...
      <AbilityDescription title="Software Architecture" icon={faPencilRuler}>
        <p>
          ...
          that adhere to SOLID and DDD principles. I&apos;ve learned from
          experience that architecture is often more than just stringing
          together boxes on a whiteboard.
        </p>
      </AbilityDescription>
      <AbilityDescription title="Mentorship" icon={faChalkboardTeacher}>
        <p>
          I owe a great deal of my success to the people who&apos;ve invested
          their time and knowledge in me. I&apos;m passionate about{' '}
      ...
      <AbilityDescription title="Leadership" icon={faPeopleCarry}>
        <p>
          ...
          is vital for any business but in startups, like the ones I&apos;ve
          been helping to succeed, this is especially true. I&apos;ve led
          successful software projects in startups through{' '}
          <Highlight>
