...
- [Framework decision](/backroom/framework-decision): why Next.js, and why not Astro.
- [Deferring the polish](/backroom/deferring-the-polish): choosing what not to build, to protect delivery.
- [Building with AI & BMAD](/backroom/building-with-ai-and-bmad): how the decisions got recorded as they were made, not reconstructed afterwards.
